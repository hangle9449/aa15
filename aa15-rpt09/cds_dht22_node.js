...
//    console.log(readData);
   firstcommaidx = readData.indexOf(',');
    // second = readData.indexOf(',',1);
   if(firstcommaidx>0) {

    temp= readData.substring(0,firstcommaidx);
    mdata2=readData.substring(firstcommaidx+1);
    second=mdata2.indexOf(',');
    humi= mdata2.substring(0,second);
    lux= mdata2.substring(second+1);    
    readData = '';
     ...
     mdata[2]=humi;
     mdata[3]=lux;
     console.log('AA15,' + mdata.toString());
